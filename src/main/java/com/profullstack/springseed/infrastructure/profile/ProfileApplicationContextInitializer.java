...
import com.profullstack.springseed.infrastructure.log.LogbackConfig;
import lombok.Data;
...
public class ProfileApplicationContextInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
	...
	public static final String PARENT_PROPERTIES_SOURCE_LOCATION = "classpath:properties/infra-${" + ACTIVE_PROFILES_PROPERTY_NAME + "}.xml";

	public static final String PARENT_PROPERTIES_SOURCE_DEFAULT_NAME = "parent_properties_property_source_default";
	public static final String PARENT_PROPERTIES_SOURCE_DEFAULT_LOCATION = "classpath:properties/infra-default.xml";
